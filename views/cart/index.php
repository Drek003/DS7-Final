...
<body class="cart-container">
    ...
    <script>
        // Función mejorada para cambiar cantidad
        function changeQuantity(cartId, change, currentQuantity) {
            ...
            .then(responseText => {
                ...
                // Actualizar totales y contador del carrito desde el servidor
                updateCartTotals();
                
                // Actualizar contador del carrito desde el servidor (no optimista)
